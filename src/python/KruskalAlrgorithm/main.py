...
def runKruskalAlgorithm(edges, n):
    ...
    # Create a singleton set for each elements of the universe 
    ds = DisjointSet()
    ds.makeSet(n)
    ...
    # MST containts exactly `V-1` edges
    while len(MST) != n - 1:
        ...
        # diffrent connected components and can be included in MST 
        if x != y:
...
if __name__ == '__main__':
    ...
    # vertex `u` ti vertex `v` having weight `w`
    edges = [ 
